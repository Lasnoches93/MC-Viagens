...
const Blog = () => {
  ...
  const getBlogPosts = () => [
    {
      id: 'about-me',
      title: t('blogArticles.aboutMe.title'),
      excerpt: t('blogArticles.aboutMe.excerpt'),
      ...
      readTime: '5 min',
      category: t('blog.categories.aboutMe'),
      featured: true,
      isAbout: true,
      aboutType: 'aboutMe'
    },
    {
      ...
      readTime: '4 min',
      category: t('blog.categories.about'),
      featured: false,
      isAbout: true,
      aboutType: 'about'
    },
    {
      id: 'my-journey',
      title: t('blogArticles.myJourney.title'),
      excerpt: t('blogArticles.myJourney.excerpt'),
      ...
      readTime: '6 min',
      category: t('blog.categories.myJourney'),
      featured: false,
      isAbout: true,
      aboutType: 'myJourney'
    },
    {
      id: 1,
      title: t('blogArticles.salarUyuni.title'),
      excerpt: t('blogArticles.salarUyuni.excerpt'),
    ...
    {
      id: 2,
      title: t('blogArticles.machuPicchu.title'),
      excerpt: t('blogArticles.machuPicchu.excerpt'),
    ...
    {
      id: 3,
      title: t('blogArticles.buenosAires.title'),
      excerpt: t('blogArticles.buenosAires.excerpt'),
    ...
    {
      id: 4,
      title: t('blogArticles.patagonia.title'),
      excerpt: t('blogArticles.patagonia.excerpt'),
    ...
    {
      id: 5,
      title: t('blogArticles.rioJaneiro.title'),
      excerpt: t('blogArticles.rioJaneiro.excerpt'),
    ...
    {
      id: 6,
      title: t('blogArticles.uruguay.title'),
      excerpt: t('blogArticles.uruguay.excerpt'),
