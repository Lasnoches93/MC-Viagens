...
const Destinations = () => {
  ...
  const data = useMemo(() => ({
    ...
    'Europe': [
      ...
      { id: 402, name: 'Paris, France', price: '€799', originalPrice: '€1099', image: 'https://images.pexels.com/photos/338515/pexels-photo-338515.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop', duration: '5 jours', flightTime: '2h', stops: 'Direct', rating: 4.8, reviews: 820, description: 'Tour Eiffel, Louvre et Seine.' },
      { id: 403, name: 'Rome, Italie', price: '€749', originalPrice: '€999', image: 'https://images.unsplash.com/photo-1549880181-56a44cf4a9a6?w=600&h=400&fit=crop&auto=format&q=80', duration: '5 jours', flightTime: '2h', stops: 'Direct', rating: 4.7, reviews: 560, description: 'Colisée, Fontaine de Trévi et Vatican.' },
