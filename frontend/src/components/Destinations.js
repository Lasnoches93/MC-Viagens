...
const Destinations = () => {
  ...
  const data = useMemo(() => ({
    ...
    'Amérique du Sud': [
      ...
      { id: 306, name: 'Montevideo, Uruguay', price: '€699', originalPrice: '€999', image: 'https://images.unsplash.com/photo-1632516659260-a74ade7ffeff?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2NDN8MHwxfHNlYXJjaHwyfHxNb250ZXZpZGVvJTIwd2F0ZXJmcm9udHxlbnwwfHx8fDE3NTgzMDE5NDN8MA&ixlib=rb-4.1.0&q=85', duration: '5 jours', flightTime: '13h', stops: '1 escale', rating: 4.5, reviews: 120, description: 'Front de mer, Rambla et plages urbaines.' }
    ],
    'Europe': [
