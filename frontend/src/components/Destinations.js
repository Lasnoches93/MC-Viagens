...
const Destinations = () => {
  ...
  const data = useMemo(() => ({
    ...
    'Europe': [
      ...
      { id: 402, name: 'Paris, France', price: '€799', originalPrice: '€1099', image: 'https://images.unsplash.com/photo-1505761671935-60b3a7427bad?w=600&h=400&fit=crop&auto=format&q=80', duration: '5 jours', flightTime: '2h', stops: 'Direct', rating: 4.8, reviews: 820, description: 'Tour Eiffel, Louvre et Seine.' },
