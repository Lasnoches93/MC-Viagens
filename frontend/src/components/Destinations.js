...
const Destinations = () => {
  ...
  const data = useMemo(() => ({
    ...
    'Amérique du Sud': [
      ...
      { id: 306, name: 'Montevideo, Uruguay', price: '€699', originalPrice: '€999', image: 'https://images.unsplash.com/photo-1721846937765-2f05a4249028?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzB8MHwxfHNlYXJjaHwyfHxNb250ZXZpZGVvJTIwVXJ1Z3VheXxlbnwwfHx8fDE3NTgzMDE0ODF8MA&ixlib=rb-4.1.0&q=85', duration: '5 jours', flightTime: '13h', stops: '1 escale', rating: 4.5, reviews: 120, description: 'Palacio Salvo, Rambla et Ciudad Vieja.' }
    ],
    'Europe': [
